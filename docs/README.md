...
### 10. [合规部署预算](./DEPLOYMENT_BUDGET.md)
**文件大小**: 12KB | **更新**: 2026-07-30
- 市级公网部署（>1 万用户、等保三级）四类费用预算
- 三档方案（首年约 60-80 万 / 100-120 万 / 130-155 万）
- 配套生成脚本 `scripts/build-deployment-budget.py`、`scripts/recalc-budget.py`
