        ...
        <div className="app-brand" aria-label="贵阳市小学生测评平台">
          <span className="app-brand-mark" aria-hidden="true">
            <svg viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
              <path d="M10.6 15.2 V19.9 C10.6 21.9 13 23.4 16 23.4 C19 23.4 21.4 21.9 21.4 19.9 V15.2 Z" />
              <path d="M16 6.2 L28.6 11.7 L16 17.2 L3.4 11.7 Z" />
              <rect x="27.95" y="11.7" width="1.3" height="6.4" rx="0.65" />
              <circle cx="28.6" cy="19.4" r="1.6" />
            </svg>
          </span>
