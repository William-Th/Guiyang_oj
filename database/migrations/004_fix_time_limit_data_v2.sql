-- Fix migration 004: Correct time_limit_type data (v2 - with trigger handling)
-- Date: 2025-10-25
...
ALTER TABLE activities DISABLE TRIGGER trigger_validate_activity_time_limit;

-- ============================================================
-- STEP 2: Update time_limit_type based on existing data
-- ============================================================
...
-- ============================================================
-- STEP 3: Clean up conflicting fields
-- ============================================================
...
ALTER TABLE activities ENABLE TRIGGER trigger_validate_activity_time_limit;

-- ============================================================
-- STEP 5: Add missing constraint
-- ============================================================
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'OK: All unlimited activities have no time fields';
  END IF;
  ...
  ELSE
    RAISE NOTICE 'OK: All scheduled activities have valid fields';
  END IF;
  ...
  ELSE
    RAISE NOTICE 'OK: All timed activities have valid fields';
  END IF;
...
SELECT '=== Distribution of time_limit_type ===' as info;
...
SELECT '=== Sample data for each type ===' as info;
SELECT id, SUBSTRING(title, 1, 30) as title,
       time_limit_type,
